...
/**
 * Interactive spotlight that follows the mouse within its parent element.
 * Parent must have position: relative (applied automatically via useEffect).
 *
 * Props:
 *   className     — additional classes on the spotlight div
