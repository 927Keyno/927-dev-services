...
export function Pricing() {
  return (
    <div id="pricing" className="snap-section flex flex-col justify-center items-center px-10 md:px-14 py-6">
      <div className="w-full flex flex-col">
        ...
        <div className="max-h-[70vh] overflow-y-auto no-scrollbar space-y-8 pr-1">
          {TIERS.map((tier, i) => {
