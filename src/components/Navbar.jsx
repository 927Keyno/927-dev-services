...
import logoImg from "@/assets/927-logo.png"
...
export function Navbar() {
  ...
  useEffect(() => {
    ...
    // Start invisible, fade in after scrolling past the hero
    ...
    ScrollTrigger.create({
      ...
      onLeaveBack: () => {
        gsap.to(el, { opacity: 0, y: -8, duration: 0.3, ease: "power2.in" })
      },
    })
  ...
  return (
    ...
    >
      ...
      <a
        ...
        onMouseEnter={(e) => {
          e.currentTarget.style.background = "rgba(147, 51, 234, 0.28)"
